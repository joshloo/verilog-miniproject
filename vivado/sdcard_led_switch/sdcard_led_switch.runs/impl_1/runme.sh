...
HD_PWD='E:/XilinxSdk/sdcard/src/verilog-miniproject/vivado/sdcard_led_switch/sdcard_led_switch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sdcard_led_switch_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sdcard_led_switch_wrapper.tcl -notrace
