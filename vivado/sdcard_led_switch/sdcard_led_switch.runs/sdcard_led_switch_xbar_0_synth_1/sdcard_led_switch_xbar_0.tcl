...
synth_design -top sdcard_led_switch_xbar_0 -part xc7z010clg400-1 -mode out_of_context

#---------------------------------------------------------
# Generate Checkpoint/Stub/Simulation Files For IP Cache
#---------------------------------------------------------
catch {
 write_checkpoint -force -noxdef -rename_prefix sdcard_led_switch_xbar_0_ sdcard_led_switch_xbar_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ sdcard_led_switch_xbar_0_stub.v
 lappend ipCachedFiles sdcard_led_switch_xbar_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ sdcard_led_switch_xbar_0_stub.vhdl
 lappend ipCachedFiles sdcard_led_switch_xbar_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ sdcard_led_switch_xbar_0_sim_netlist.v
 lappend ipCachedFiles sdcard_led_switch_xbar_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ sdcard_led_switch_xbar_0_sim_netlist.vhdl
 lappend ipCachedFiles sdcard_led_switch_xbar_0_sim_netlist.vhdl

 config_ip_cache -add -dcp sdcard_led_switch_xbar_0.dcp -move_files $ipCachedFiles -use_project_ipc -ip [get_ips sdcard_led_switch_xbar_0]
}

rename_ref -prefix_all sdcard_led_switch_xbar_0_

write_checkpoint -force -noxdef sdcard_led_switch_xbar_0.dcp
