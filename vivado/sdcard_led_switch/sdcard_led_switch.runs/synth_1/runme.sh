...
HD_PWD='E:/XilinxSdk/sdcard/src/verilog-miniproject/vivado/sdcard_led_switch/sdcard_led_switch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sdcard_led_switch_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sdcard_led_switch_wrapper.tcl
