...
HD_PWD='E:/XilinxSdk/verilog-miniproject/vivado/sdcard_led_switch/sdcard_led_switch.runs/sdcard_led_switch_arbitor_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sdcard_led_switch_arbitor_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sdcard_led_switch_arbitor_0_0.tcl
